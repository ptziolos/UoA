...
__device__ 
void warp(volatile int *shared_memory, int t) {
	shared_memory[t] += shared_memory[t + 32];
	shared_memory[t] += shared_memory[t + 16];
	shared_memory[t] += shared_memory[t + 8];
	shared_memory[t] += shared_memory[t + 4];
	shared_memory[t] += shared_memory[t + 2];
	shared_memory[t] += shared_memory[t + 1];
}
