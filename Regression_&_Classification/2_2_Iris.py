...
def main(file):
    ...
    print("\n________Class2__________")
    print("\nmean = " + str(mean_value_2))
    print("\nsigma estimator = " + str(sigma_estimator_2))
    print("\nCovariance Matrix:")
    ...
    n_a_2 = len(classes[2])
    k_a_2 = 5
    aic_a_2 = -2 * calculate_log_likelihood_a(sigma_estimator_2, mean_value_2, classes[2]) \
              + 2 * k_a_2 + (2 * k_a_2 + 1) / (n_a_2 - k_a_2 - 1)
    bic_a_2 = -2 * calculate_log_likelihood_a(sigma_estimator_2, mean_value_2, classes[2]) \
              + k_a_2 * numpy.log(n_a_2)
    print("\nThe AIC for prob_a is : "+str(aic_a_2))
    print("The BIC for prob_a is : "+str(bic_a_2))

    n_b_2 = len(classes[2])
    k_b_2 = 14
    aic_b_2 = -2 * calculate_log_likelihood_b(covariance_matrix_2, mean_value_2, classes[2]) \
              + 2 * k_b_2 + (2 * k_b_2 + 1) / (n_b_2 - k_b_2 - 1)
    bic_b_2 = -2 * calculate_log_likelihood_b(covariance_matrix_2, mean_value_2, classes[2]) \
              + k_b_2 * numpy.log(n_b_2)
    print("\nThe AIC for prob_b is : " + str(aic_b_2))
    print("The BIC for prob_b is : " + str(bic_b_2))

    n_c_2 = len(classes[2])
    k_c_2 = 8
    aic_c_2 = -2 * calculate_log_likelihood_c(variance_2, mean_value_2, classes[2]) \
              + 2 * k_c_2 + (2 * k_c_2 + 1) / (n_c_2 - k_c_2 - 1)
    bic_c_2 = -2 * calculate_log_likelihood_c(variance_2, mean_value_2, classes[2]) \
              + k_c_2 * numpy.log(n_c_2)
    print("\nThe AIC for prob_c is : " + str(aic_c_2))
    print("The BIC for prob_c is : " + str(bic_c_2))

    h_2 = len(classes[2])
    n_d_2 = len(classes[2])
    k_d_2 = 1
    aic_d_2 = -2 * calculate_log_likelihood_d(h_2, classes[2]) \
              + 2 * k_d_2 + (2 * k_d_2 + 1) / (n_d_2 - k_d_2 - 1)
    bic_d_2 = -2 * calculate_log_likelihood_d(h_2, classes[2]) \
              + k_d_2 * numpy.log(n_d_2)
    print("\nThe AIC for prob_d is : " + str(aic_d_2))
    print("The BIC for prob_d is : " + str(bic_d_2))
