...
def main(file):
    ...
    for k in range(1, 42, 2):
        ...
        for i in range(5):
            ...
            types_collection = use_knn_method(sets, k, covariance_matrix_0, covariance_matrix_1, covariance_matrix_2)
    ...
    for i in misclassifications:
        ...
        accuracy_percentage.append(100 - 100 * i[1]/(30 * 5))
    percentage = 100 - 100 * minimum/(30 * 5)
...
def use_knn_method(sets, k, covariance_matrix_0, covariance_matrix_1, covariance_matrix_2):
    distances = []
    classified_type = []
    true_type = []
    for query_example in sets[0][1]:
        ...
        for example in sets[0][0]:
            ...
            d2 = calculate_mahalanobis_distance(query_example, example, covariance_matrix_2)
            if d0 < d1 and d0 < d2:
                d = d0
