...
def create_model(img_size, weights, state):
	...
	c1 = m.Model(inputs=EfficientNetB6_base.input, outputs=EfficientNetB6_base.get_layer('block2a_expand_activation').output)
	c2 = m.Model(inputs=EfficientNetB6_base.input, outputs=EfficientNetB6_base.get_layer('block3a_expand_activation').output)
	c3 = m.Model(inputs=EfficientNetB6_base.input, outputs=EfficientNetB6_base.get_layer('block4a_expand_activation').output)
	c4 = m.Model(inputs=EfficientNetB6_base.input, outputs=EfficientNetB6_base.get_layer('block6a_expand_activation').output)
