...
def create_model(img_size, weights, state):
	...
	c1 = m.Model(inputs=DenseNet121_base.input, outputs=DenseNet121_base.get_layer('conv1/conv').output)
	c2 = m.Model(inputs=DenseNet121_base.input, outputs=DenseNet121_base.get_layer('conv2_block1_0_relu').output)
	c3 = m.Model(inputs=DenseNet121_base.input, outputs=DenseNet121_base.get_layer('conv3_block1_0_relu').output)
	c4 = m.Model(inputs=DenseNet121_base.input, outputs=DenseNet121_base.get_layer('conv4_block1_0_relu').output)
