...
unet_dictionary = {
	"n1": "VGG19_linked",
	"n2": "ResNet152V2_linked",
	"n3": "InceptionV3_linked",
	"n4": "Xception_linked",
	"n5": "MobileNetV2_linked",
	"n6": "DenseNet121_linked",
	"n7": "DenseNet169_linked",
	"n8": "NASNetMobile_linked",
	"n9": "EfficientNetB1_linked",
	}
...
for i in range(1,2):
	...
	n=7
	plt.figure(figsize=(n,1), dpi=700)
	for i in tqdm(range(1,n+1)):
		plt.subplot(1,n,i)
		#plt.title("RGB")
		plt.axis('off')
		plt.imshow(test_x[i])
	plt.savefig("/home/ptziolos/Desktop/images/RGB")
	for i in tqdm(range(1,n+1)):
		plt.subplot(1,n,i)
		#plt.title("GT")
		plt.axis('off')
		plt.imshow(np.squeeze(test_y[i]), cmap="gray")
	plt.savefig("/home/ptziolos/Desktop/images/GT")
	for j in range(9,10):
		net = unet_dictionary[f"n{j}"]
		k=j+1
		segment_images()
		plt.savefig("/home/ptziolos/Desktop/images/"+net)
