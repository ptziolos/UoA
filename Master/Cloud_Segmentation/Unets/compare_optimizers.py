...
lr = 1e-4
optimizers_dictionary = {
	"o1": o.Adadelta(learning_rate=lr),
	"o2": o.Adagrad(learning_rate=lr),
	"o3": o.Adam(learning_rate=lr),
	"o4": o.Adamax(learning_rate=lr),
	"o5": o.Ftrl(learning_rate=lr),
	"o6": o.Nadam(learning_rate=lr),
	"o7": o.RMSprop(learning_rate=lr),
	"o8": o.SGD(learning_rate=lr),
	"o9": op.AdamW(learning_rate=lr,weight_decay=1e-5),
	"o10": op.ConditionalGradient(learning_rate=lr),
	"o11": op.LAMB(learning_rate=lr),
	"o12": op.LazyAdam(learning_rate=lr),
	"o13": op.ProximalAdagrad(learning_rate=lr),
	"o14": op.RectifiedAdam(learning_rate=lr),
	"o15": op.SGDW(learning_rate=lr,weight_decay=1e-5),
	"o16": op.Yogi(learning_rate=lr),
}
...
def train_network(codename, optimizer):
...
# Train the model
	...
	checkpointer = tf.keras.callbacks.ModelCheckpoint(
	                                   filepath = r"/home/ptziolos/Desktop/optimizer_results/" + net.name+"_"+codename+"_"+dataset, 
...
# Save history
	...
	with open(r"/home/ptziolos/Desktop/optimizer_results/" + net.name+"_"+codename+"_"+dataset + "__History", 'wb') as the_file:
