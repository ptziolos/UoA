...
def res_block(inputs, f, k, s, d=(3,3)):
	out_1 = conv_unit(inputs, f, 1, s, 1)
	out_2 = conv_unit(out_1, 2*f, k, s, d)
	out_3 = l.Concatenate()([out_1,out_2])
	out_4 = conv_unit(out_3, 2*f, k, s, d)
	out_5 = l.Concatenate()([out_3,out_4])
	out_6 = conv_unit(out_5, 2*f, k, s, d)
	out_7 = l.Concatenate()([out_5,out_6])
	out_8 = conv_unit(out_7, f, 1, s, 1)
	out = l.Add()([out_1,out_8])
	return out

def intra_block_1(inputs, f, k1, s1, k2, s2):
	out_1 = res_block(inputs, f, k1, s1)
...
def create_model(img_size):
	...
	(out_3,out_4) = intra_block_1(out_2, 20, 3, 1, 2, 2)
	(out_5,out_6) = intra_block_1(out_4, 24, 3, 1, 3, 2)
	(out_7,out_8) = intra_block_1(out_6, 28, 3, 1, 3, 2)
	out_9 = intra_block_2(out_8, 32, 3, 1, 3, 2)
	out_10 = l.Concatenate()([out_7,out_9])
	out_11 = intra_block_2(out_10, 28, 3, 1, 3, 2)
	out_12 = l.Concatenate()([out_5,out_11])
	out_13 = intra_block_2(out_12, 24, 3, 1, 2, 2)
	out_14 = l.Concatenate()([out_3,out_13])
	out_15 = intra_block_2(out_14, 20, 3, 1, 2, 2)
