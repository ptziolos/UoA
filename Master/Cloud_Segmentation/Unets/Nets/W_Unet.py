...
def double_block(inputs, f, k, s):
	block_1 = single_block(inputs, f, 1, s, 1)
	block_2 = single_block(block_1, f, k, s)
	block_3 = single_block(block_1, f, (1,3), s)
	block_3 = single_block(block_3, f, (3,1), s)
	power_bond = l.Concatenate()([block_1,block_2,block_3])
	return power_bond

def intra_block_1(inputs, f, k1, s1, k2, s2):
	out_1 = double_block(inputs, f, k1, s1)
...
def create_model(img_size):
	...
	out_17 = single_block(out_16, 16, 3, 1)
