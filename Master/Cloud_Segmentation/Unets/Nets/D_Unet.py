...
def triple_block(inputs, f, k, s):
	block_1 = single_block(inputs, f, k, s, d=(1,1))
	block_2 = single_block(inputs, f, k, s, d=(3,3))
	block_3 = single_block(inputs, f, k, s, d=(5,5))
	power_bond = l.Concatenate()([block_1,block_2,block_3])
	return power_bond

def intra_block_1(inputs, f, k1, s1, k2, s2):
	out_1 = triple_block(inputs, f, k1, s1)
