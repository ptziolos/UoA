...
loss_functions_dictionary = {
	"l1": tf.losses.binary_crossentropy,
	"l2": lf.dice,
	"l3": lf.jaccard,
	"l4": lf.tversky,
	"l5": lf.powerJaccard,
	"l6": lf.fbeta_score,
	"l7": lf.fbetaPowerJaccard,
	"l8": lf.logCoshJaccard,
	"l9": lf.logCoshDice,
	"l10": lf.binaryCrossEntropyDice,
	"l11": lf.binaryCrossEntropylogCoshJaccard,
	"l12": lf.tverskyfbeta,
}

loss_functions_codename_dictionary = {
	"c1": "binaryCrossEntropy",
	"c2": "dice",
	"c3": "jaccard",
	"c4": "tversky",
	"c5": "powerJaccard",
	"c6": "fbeta_score",
	"c7": "fbetaPowerJaccard",
	"c8": "logCoshJaccard",
	"c9": "logCoshDice",
	"c10": "binaryCrossEntropyDice",
	"c11": "binaryCrossEntropylogCoshJaccard",
	"c12": "tverskyfbeta",
}
...
# Train the model
	...
	checkpointer = tf.keras.callbacks.ModelCheckpoint(
	                                   filepath = r"/home/ptziolos/Desktop/loss_results/" + net.name+"_"+codename+"_"+dataset, 
...
# Save history
	...
	with open(r"/home/ptziolos/Desktop/loss_results/" + net.name+"_"+codename+"_"+dataset + "__History", 'wb') as the_file:
...
for i in range(1,13):
	codename = loss_functions_codename_dictionary[f"c{i}"]
	loss = loss_functions_dictionary[f"l{i}"]
