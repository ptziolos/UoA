...
// Insertion of the edges in a sorted list - O(E)
void push3(np edge,np nox)
{
	np temp3,aux3;
	int key;
	...
	if (((h3!=NULL) && (h3->n!=NULL) && (temp3->v < h3->v)) || ((nox->i == temp3->i) && (nox->a->i == temp3->j)))
	{	
		temp3->n=h3;
		if (h3!=NULL)
		{
